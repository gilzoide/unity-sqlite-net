...
- `SQLiteConnection.Deserialize` extension method for deserializing memory (`byte[]`) into an open SQLiteConnection (reference: [SQLite Deserialization](https://www.sqlite.org/c3ref/deserialize.html)).
